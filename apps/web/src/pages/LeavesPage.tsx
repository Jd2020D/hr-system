    ...
    <div>
      ...
      {isEmployee && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="card">
            <h3 className="font-semibold text-gray-600 mb-2">Annual Leave</h3>
            <p className="text-2xl font-bold text-primary-600">21 days</p>
            <p className="text-sm text-gray-500 mt-1">Available</p>
          </div>
          <div className="card">
            <h3 className="font-semibold text-gray-600 mb-2">Sick Leave</h3>
            <p className="text-2xl font-bold text-primary-600">7 days</p>
            <p className="text-sm text-gray-500 mt-1">Available</p>
          </div>
          <div className="card">
            <h3 className="font-semibold text-gray-600 mb-2">Unpaid Leave</h3>
