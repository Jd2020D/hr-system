...
export const attendanceApi = {
  clockIn: () =>
    api.post<ApiResponse<AttendanceLog>>('/attendance/clock-in'),
  
  clockOut: () =>
    api.post<ApiResponse<AttendanceLog>>('/attendance/clock-out'),
  
  getLogs: (params?: any) =>
    api.get<ApiResponse & PaginatedResponse<AttendanceLog>>('/attendance/logs', { params }),
...
export const leaveApi = {
  getRequests: (params?: any) =>
    api.get<ApiResponse & PaginatedResponse<LeaveRequest>>('/leaves/requests', { params }),
...
export const payrollApi = {
  getRuns: (params?: any) =>
    api.get<ApiResponse & PaginatedResponse<PayrollRun>>('/payroll/runs', { params }),
...
export const settingsApi = {
  ...
  // Shifts
  getShifts: () =>
    api.get<ApiResponse<Shift[]>>('/settings/shifts'),
...
export const projectApi = {
  ...
  getExpenses: (projectId: string, params?: any) =>
    api.get<ApiResponse & PaginatedResponse<any>>(`/projects/${projectId}/expenses`, { params }),
  ...
  getInvoices: (projectId: string, params?: any) =>
    api.get<ApiResponse & PaginatedResponse<any>>(`/projects/${projectId}/invoices`, { params }),
  ...
  getPayments: (projectId: string, params?: any) =>
    api.get<ApiResponse & PaginatedResponse<any>>(`/projects/${projectId}/payments`, { params }),
